...
class Q20(object):
    ...
    def play(self):
        ...
        print 'You should do the following: ',self.ts[best_guess]
        ans_str = raw_input('Would this help you? (y/n) ')
        while ans_str != 'y' and ans_str != 'n':
            ans_str = raw_input('Invalid. Answer? (y/n) ')
        if ans_str == 'y':
            print '\nGREAT!.'
            ...
            print '\nWe will improve our tool\n'
            print 'What would you have prefered now?'
            
            t_str = raw_input('Options: ')
            while t_str not in self.ts:
                t_str = raw_input('Not in list, select again. Options: ')
